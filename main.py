...
async def Room_Spam(Uid, Rm, Nm, K, V):
    ...
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] MSR_MONSTAR CODEX  CODEX",  
            3: {
                2: 1,
                3: 1
            },
        ...
        fields = {
            ...
            2: {   # data
                ...
                9: {    # field9 - player details
                    1: "[C][B][FF0000] CRIMINAL ON TOP",  # Nickname
...
[FFFFFF]          ⚡ CRIMINAL CODEX  CODEX ❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF] CRIMINAL FF   
[FFD700]✨ Name on instagram : [FFFFFF] MSR_MONSTAR❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> CRIMINAL DEV❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "RAIHAN", key, iv)
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493] CRIMINAL X CODEX  CODEX
...
async def MaiiiinE():
    Uid , Pw = '4311729043','910B951588859266E53AFFDDD0395563B44BCBCD398519A9CEF952ECE7BEAAF3'
    ...
    os.system('clear')
    print("Initializing CRIMINAL X CODEX  Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    print("🤖 CRIMINAL X CODEX BOT- ONLINE")
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    print(f"🔹 UID: {TarGeT}")
    ...
    os.system('clear')
    print(render('CRIMINAL', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 CRIMINAL BOT- ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
    print(f"🔹 Status: 🟢 READY")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using CRIMINAL ❤️ CODEX ")
    sys.exit(0)
...
async def StarTinG():
    while True:
        try:
            ...
            print("👋 Thanks for using CRIMINAL CODEX!")
            break
